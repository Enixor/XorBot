...
public class GuildMemberWarnAddEvent implements PunishmentEvent {
    ...
    public GuildMemberWarnAddEvent(Member target, Member executor, String reason, Duration duration) {
